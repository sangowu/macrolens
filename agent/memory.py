...
_EXTRACT_SYSTEM = """\
You are a research memory extractor. Given a question and its answer, extract 2-4 key findings worth remembering for future research sessions.

Output a JSON array only:
[
  {"memory_type": "finding", "content": "...", "fiscal_year": 2022},
  {"memory_type": "open_question", "content": "...", "fiscal_year": null}
]

memory_type options:
- "finding": a concrete fact or conclusion that was established
- "open_question": something that couldn't be answered due to missing data
...
def extract_and_store(
    ...
    try:
        memories: list[dict] = json.loads(match.group(0))
